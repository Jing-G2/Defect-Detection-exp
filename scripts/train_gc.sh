...
# export exp_name=${model_name}'_tsne_gc_'${data_name}
# export model_dir=${result_path}${exp_name}'/models'
# export data_dir='/nfs4-p1/gj/DEFECT2022/data0'
...
#   >> /nfs4-p1/gj/DEFECT2022/log/${model_name}/${exp_name}_tsne_train.log
...
python train_gc.py \
  ...
  --log_dir ${log_dir} \
  --device_index ${device_index} \
  >> /nfs4-p1/gj/DEFECT2022/log/${model_name}/${exp_name}_gray_train.log
